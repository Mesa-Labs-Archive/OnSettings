...
import com.mesalabs.on.romcontrol.ui.preference.MesaPreferenceCategory;
import com.mesalabs.on.romcontrol.ui.preference.MesaSeekBarPreference;
import com.mesalabs.on.romcontrol.ui.preference.MesaSwitchPreferenceScreen;
...
public class SettingsTestFragment1 extends BasePreferenceTabFragment implements
    ...
    public void onCreate(Bundle bundle) {
        ...
        final MesaPreferenceCategory padding = (MesaPreferenceCategory) findPreference("padding");
        ...
        MesaSwitchPreferenceScreen switchbar_test = (MesaSwitchPreferenceScreen) findPreference("switchbar_test");
        ...
        MesaSeekBarPreference key81 = (MesaSeekBarPreference) findPreference("key81");
        key81.setOnPreferenceChangeListener(this);
    ...
    public boolean onPreferenceChange(SeslPreference preference, Object newValue) {
        ...
        if (preference.getKey().equals("key81")) {
            return true;
        }
